...
<%
Object o=session.getAttribute("going to employeeprovidingOTP.jsp");
if(o!=null){
	
	
	session.removeAttribute("going to employeeprovidingOTP.jsp");
	session.setAttribute("going to employeeVerificationOPTServlet", "going to employeeVerificationOPTServlet");
%>

<h4>provide OTP</h4>
<form action="employeeVerificationOPTServlet" mehod="get">
