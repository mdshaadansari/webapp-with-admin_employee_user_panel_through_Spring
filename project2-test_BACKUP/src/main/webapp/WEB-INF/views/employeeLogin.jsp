...
<!-- 
  <div class="title-bar" style="border-radius: 25px 25px 0px 0px;color:black">
       ...
       <div class="menu-item">assign/release
            <div class="dropdown">
                <a href="selectProject_step1">assign project to employee</a>
                <a href="selectClient_step1">assign client to project</a>
                <a href="selectClientToAddContactPerson_setp1">assign contact person to client</a>
                <a href="selectProjectToReleaseEmployee_step1">release Employee from Project</a> 
            </div>
        </div>
        <div class="menu-item">search
            <div class="dropdown">
                <a href="searchClient_step1">search in client</a>
                <a href="searchProject_step1">search in project</a>
                <a href="searchEmployee_step1">search in employee</a>
            </div>
        </div>
        <div class="menu-item">delete/update
            <div class="dropdown">
                     <a href="update_delete_client_step1">update/delete client</a>
                <a href="update_delete_project_step1">update/delete project</a>
                <a href="update_delete_employee_step1">update/delete employee</a>
            </div>
        </div> 
        <div class="menu-item">login as
            <div class="dropdown">
               <a href="clientLogin">login as client</a>
                <a href="employeeLogin">login as employee</a>
            </div>
        </div> 
...
<form action="employeeLoginView" method="get">
