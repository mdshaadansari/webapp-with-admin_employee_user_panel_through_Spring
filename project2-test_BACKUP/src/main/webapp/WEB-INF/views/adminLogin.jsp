...
<div style="height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;       ;border-bottom-width:0px;">
 ...
 <div style="height:300px;width:250px;display:flex;flex-direction:column; align-items:center; box-shadow:0px 20px 40px 0px black;border-radius:20px">
...
<form action="adminLoginView" method="get">
...
<!-- Toastify -->
 <script>
        document.addEventListener("DOMContentLoaded", function() {
            Toastify({
                text: "<%="wait for "+ a+" sec.." %>", // Inject JSP variable
                duration: 3000,
                close: true, 
