...
<%
Object o=session.getAttribute("going to clientprovidingOTP.jsp");
if(o!=null){
	session.removeAttribute("going to clientprovidingOTP.jsp");
	session.setAttribute("going to clientVerificationOPTServlet", "going to clientVerificationOPTServlet");
%>

<h4>provide OTP</h4>
<form action="clientVerificationOPTServlet" mehod="get">
