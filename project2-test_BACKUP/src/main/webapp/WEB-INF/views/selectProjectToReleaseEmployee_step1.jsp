...
if(listOfProjectID!=null&&listOfProjectID!=null){
...
<form action="selectProjectToReleaseEmployee_step1_releasingEmployeeFromProject_step2" method="get" onsubmit="return validateInput()">
